...
def tsne_plot(objects: np.ndarray, prototypes: np.ndarray, object_legend_text: str = 'Object', labels: np.ndarray = ['#74add1'], sizes: np.ndarray = [30], perplexity: int = 5,
              path_save_fig: str = None, title: str = 'TSNE plot for Object (user/item) Embeddings'):
    """
    ...
    plt.scatter(tsne_protos[:, 0], tsne_protos[:, 1], s=1000, c='#d73027', alpha=0.3, label='Prototypes', marker='^')

...
class FeatureExtractorFactory:
    ...
    def create_model(ft_ext_param: dict, n_objects: int, embedding_dim: int) -> FeatureExtractor:
        ...
        if ft_type == 'embedding':
            ...
            sim_fairness_regularizer_weight = ft_ext_param['sim_fairness_regularizer_weight'] if 'sim_fairness_regularizer_weight' in ft_ext_param else 1.
            ...
            model = PrototypeEmbedding(n_objects=n_objects, embedding_dim=embedding_dim, n_prototypes=n_prototypes, use_weight_matrix=use_weight_matrix, sim_proto_weight=sim_proto_weight, sim_fairness_regularizer_weight=sim_fairness_regularizer_weight, sim_proto_vectors_weight=sim_proto_vectors_weight,
